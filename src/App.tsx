...
const defaultState = {
  appId: "c71891ada6d94c83b22cf9b602a1a463",
  channel: "xxd",
  uid: "",
  token: "007eJxTYJjwodPlLfP2h5ZftP7KZUR78v7ulBfpsJux9uFSq+BbqgoKDMnmhhaWhokpiWYplibJFsZJRkbJaZZJZgZGiYaJJmbGOT6Cya/mCiX/4uRmYmSAQBCfmaGiIoWBAQAxsx/e",
  cameraId: "",
  microphoneId: "",
  mode: "rtc",
  codec: "h264"
    ...
    <React.Fragment>
      ...
      <Toolbar className={classes.divider} />
       ...
       <Grid item xs={12} md={8}>
          ...
          <JoinLeaveBtn />
      <Container>
        <Grid style={{display: 'none'}} container spacing={3}>
          {/* form */}
